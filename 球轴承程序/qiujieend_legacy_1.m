function [loadj,returndata]=qiujieend_legacy_1(datafromvb)
...
datafromvb(1)=12;datafromvb(2)=0.023812;datafromvb(3)=0.1253;datafromvb(4)=0.525;datafromvb(5)=0.515;datafromvb(6)=15; datafromvb(7)=0.0115;datafromvb(35)=5;
datafromvb(61)=7850; datafromvb(68)=7850; datafromvb(51)=7850; datafromvb(50)=7850; datafromvb(9)=2.06e+11;datafromvb(10)=2.06e+11;datafromvb(11)= 2.06e+11; 
datafromvb(65)=2.06e+11; datafromvb(12)=0.3; datafromvb(13)=0.3; datafromvb(14)=0.3; datafromvb(66)=0.3;datafromvb(69)=0; datafromvb(15)=9900;datafromvb(16)=15000 ;datafromvb(17)=0; 
datafromvb(18)=2000; datafromvb(19)=0; datafromvb(20)=0;datafromvb(21)=0.275;datafromvb(22)=0.225;datafromvb(23)=1e-07;datafromvb(24)=1e-07;datafromvb(25)=1e-07;datafromvb(26)=972; 
datafromvb(27)=20;datafromvb(28)=0.0966;datafromvb(29)=0.0318; datafromvb(30)=1.25e-008; datafromvb(31)=3.2e-002; datafromvb(32)=1; datafromvb(33)=0.4e-03; datafromvb(34)=3.8; 
datafromvb(74)=2;datafromvb(36)=3639e-04;datafromvb(37)=307e-03;datafromvb(38)=120.0e-03;datafromvb(39)=225e-03;datafromvb(40)=1.96e11;datafromvb(41)=2.18e11;datafromvb(42)=0.3;datafromvb(43)=0.3;
...
Famax1(datafromvb);load Famax;load deltapd;load deltapt1;load deltapt2;load deltapf1;load deltapf2;load deltaw;load Fyindao;load fyindao;load zuoyongjiao
...
%非承载半圈最小间隙
for i=1:loadj
    orv=sqrt(((2*f2-1)*Dw*sin(dianpianjiao/180*pi))^2+(Dm/2+(f2-0.5)*Dw-deltar0/4)^2);
    racecenterx=((f2-0.5)*Dw*sin(dianpianjiao/180*pi)-www3(2*loadj+1)+orv*sin(www3(2*loadj+4))*cos(sitajiao(i))-orv*sin(www3(2*loadj+5))*sin(sitajiao(i))-www3(i));
...
% 写入文本用来保存
% 页眉
fid=fopen(bearingOutputPath('bearing','qiu','legacy_result.txt'),'w','n','UTF-8');
fprintf(fid,'\t\t\t\t\t\t************************\n');
...
print(gcf,'-djpeg',bearingOutputPath('bearing','qiu','legacy_plot.jpg'))    % 球接触载荷分布
...
print(gcf,'-djpeg',bearingOutputPath('bearing','qiu','legacy_plot.jpg'))      % pv值分布
subplot(1,1,1);plot(allsitajiao,allxuan2);xlabel('方位角（度）');ylabel('旋滚比');
print(gcf,'-djpeg',bearingOutputPath('bearing','qiu','legacy_plot.jpg'))      % 旋滚值分布
subplot(1,1,1);plot(allsitajiao,allWo*30/pi);xlabel('方位角（度）');ylabel('转速(r/min)');
print(gcf,'-djpeg',bearingOutputPath('bearing','qiu','legacy_plot.jpg'))      % 公转转速分布
